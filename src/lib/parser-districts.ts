...
export const PARSER_DISTRICTS: ParserDistrict[] = [
  ...
  },
  {
    name: "გლდანი",
    city: "თბილისი",
    titleMarkers: ["გლდანი", "გლდანში", "გლდანზე", "გლდანის"],
    streets: [],
    conflictingMarkers: [],
  },
  {
  ...
  },
  {
    ...
    streets: [],
    conflictingMarkers: ["ნუცუბიძე"],
  },
  {
    name: "ნუცუბიძის პლატო",
    city: "თბილისი",
    titleMarkers: [
      "ნუცუბიძე",
      "ნუცუბიძის",
    ...
    streets: [],
    conflictingMarkers: ["ვაჟა-ფშაველა", "ვაჟა ფშაველა"],
  },
  {
    name: "დიღმის მასივი",
    city: "თბილისი",
    ...
    streets: [],
    conflictingMarkers: ["დიდი დიღომი"],
  },
  {
    name: "დიდი დიღომი",
    city: "თბილისი",
